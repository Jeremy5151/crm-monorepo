...
const translations = {
  ru: {
    ...
    'settings.accentColor.description': 'Выберите акцентный цвет для кнопок и выделения элементов.',
    ...
    'brokers.edit_integration': 'Редактировать интеграцию',
    'brokers.delete_integration': 'Удалить интеграцию',
    ...
    'leads.send_tooltip': 'Некоторые лиды уже отправлены. Используйте \\',
  ...
  en: {
    ...
    'settings.accentColor.description': 'Choose accent color for buttons and highlighted elements.',
    ...
    'brokers.edit_integration': 'Edit integration',
    'brokers.delete_integration': 'Delete integration',
    ...
    'leads.sent_date_range': 'Sent At range',
    'leads.from': 'From',
    'leads.to': 'To',
    ...
    'leads.send': 'Send',
    'leads.send_tooltip': 'Some leads are already sent. Use \\',
    'leads.sent': 'Sent',
    'leads.url': 'URL',
